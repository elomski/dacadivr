...
const Page = () => {
  ...
  return (
    ...
    {/* Div fixée */}
    {/* <div className="fixed-div w-[49%] h-screen overflow-y-auto "></div> */}
  
    {/* Div contenant le formulaire avec défilement */}
    <div className="w-1/2 flex items-center justify-end flex-col mt-3 mb-3">
    ...
    flex justify-center items-center 
      "
        ...
        <p className="flex justify-center text-center ">
          Renseignez les différents champs pour votre enregistrement
        </p>
        <form>
          <div className="flex flex-col">
          ...
          <button
            type="submit"
            className="border bg-slate-800 text-white w-full py-2 mb-4"
          >
            Soumettre
          </button>
        </form>
